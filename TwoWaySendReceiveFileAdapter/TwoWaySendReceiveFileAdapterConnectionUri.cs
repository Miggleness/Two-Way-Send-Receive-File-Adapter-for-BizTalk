...
{
    public class TwoWaySendReceiveFileAdapterConnectionUri : ConnectionUri
    {
        ...
        /// </summary>
        public TwoWaySendReceiveFileAdapterConnectionUri()
        {
            Initialize(null);
        }
        ...
        public TwoWaySendReceiveFileAdapterConnectionUri(Uri uri)
            : base()
        {
            Initialize(uri);
        }
        ...
        public void Initialize(Uri uri)
        {
            ...
            this._uriBuilder.Scheme = TwoWaySendReceiveFileAdapter.SCHEME;
        ...
        public override Uri Uri
        {
            ...
            set
            {
                TwoWaySendReceiveFileAdapterUtilities.Trace.Trace(TraceEventType.Verbose, "TwoWaySendReceiveFile", "In Uri Set with " + value);
                ValidateUri(value);
                ParseUri(value);
            }
        }
        ...
        public override string SampleUriString
        {
            get
            {
                return TwoWaySendReceiveFileAdapter.SCHEME + "://";
            }
        }
